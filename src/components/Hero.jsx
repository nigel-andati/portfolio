        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-primary font-medium text-sm tracking-wider uppercase mb-3">
              Software Engineer &middot; Backend Systems &middot; AI Infrastructure
            </p>
            ...
            <p className="text-lg text-gray-500 leading-relaxed mb-8 max-w-lg">
              Computer Science student at Duke University with production
              experience designing backend systems, shipping full-stack features,
              and building AI-integrated infrastructure across multiple internships.
            </p>
